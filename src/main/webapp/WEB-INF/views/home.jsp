...
<head>
	...
	<div class="hero with-featured-image">
		<article id="post-106" class="post-106 page type-page status-publish has-post-thumbnail hentry">
			<div class="entry-content">
				...
				<p><a class="button" href="/paypal/member/register.action">지금 가입하기</a></p>
			</div>
		</article>
	</div>

	<div id="quaternary" class="featured-page-area">
		<div class="featured-page-wrapper clear" style="text-align: center">

	    <div class="featured-page">
						
							
	<article id="post-117" class="post-117 page type-page status-publish has-post-thumbnail hentry" style="text-align: left">
	...
	<article id="post-120" class="post-120 page type-page status-publish has-post-thumbnail hentry" style="text-align: center">
		<a class="post-thumbnail">
	...
	<article id="post-122" class="post-122 page type-page status-publish has-post-thumbnail hentry" >
		<a class="post-thumbnail">
			...
			<header class="entry-header">
				<h1 class="entry-title">
					<a href="" rel="bookmark">12번가</a>
				</h1>
			</header>
		<div class="entry-summary">
			<p>SK 플래닛 오픈마켓, 패션, 백화점, 마트, 리빙, 레저 전문관, 도서, 배송 등 안내</p>
			<p><a class="more-link" href="" rel="bookmark">
				쇼핑하기 <span class="screen-reader-text">12st</span>		</a></p>
		</div>
	</article>
...
<!--
	...
	31360 bytes batcached for 300 seconds
-->
